...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            terms["mse"] = mean_flat(((target - model_output)/2.0) ** 2)
            if "vb" in terms:
                terms["loss"] = terms["mse"] + terms["vb"] / 4.0 # vb reduced to match reduction of mse term
            else:
...
class DGLoss(nn.Module) :
    ...
    def forward(self, inputs, preds, targets) :
        ...
        # Calculate DG Loss
        dg_loss = th.log10(loss_denominator / loss_numerator)
